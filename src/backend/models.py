...
class Transaction(Base):
    ...
    Attributes:
        ...
        type (str): 거래 유형 (DEPOSIT, WITHDRAW, BUY, SELL, DIVIDEND, INTEREST, FEE, TAX, ADJUSTMENT)
        quantity (float): 수량
        price (float): 거래 단가
    ...
    type = Column(String, nullable=False)  # DEPOSIT, WITHDRAW, BUY, SELL, DIVIDEND, INTEREST, FEE, TAX, ADJUSTMENT
