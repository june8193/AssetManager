    ...
    global.fetch.mockImplementation((url) => {
      ...
      if (url.includes('/calculate')) {
        return Promise.resolve({ ok: true, json: () => Promise.resolve({ 
          ...
          asset_profits: [
            { asset_id: 10, ticker: '005930', asset_name: '삼성전자', country: 'KR', period_profit: 50000, current_valuation: 600000, last_valuation: 550000, period_buy: 0, period_sell: 0, period_dividend: 0 }
          ]
        }) });
      }
      return Promise.resolve({ ok: true, json: () => Promise.resolve({}) });
