"""스냅샷 생성 마법사의 UI 및 확정 상태 유지를 검증하는 E2E 테스트 스크립트.

Playwright를 사용하여 로컬 개발 서버에 접속한 후, 스냅샷 생성 단계별
(기본 정보 입력, 증권사 상세 입력 및 확정, 은행 계좌 선택 및 확정, 저장)
동작을 시뮬레이션하고 스크린샷을 저장하며 정상 동작 여부를 확인합니다.
"""
import os
import sys
import sqlite3
